...
public class AsmrRandomFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.fragment_asmr_random,container,false);
        initView(rootview);
        initData(context);
    ...
    private void initData(Context context) {
        ...
        AsmrHttpJson.getAsmr_randomData(new HttpAsmrJsonResolution() {
            @Override
